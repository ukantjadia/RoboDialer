...
class UserLeadDraft(db.Model):
    ...
    draft_data = db.Column('draft_data', JSONB, nullable=False)
    ...
    is_favorite = db.Column('is_favorite', Boolean, default=False, nullable=False)
    notes = db.Column('notes', JSONB, nullable=True)
    person_is_favorite = db.Column('person_is_favorite', Boolean, default=False, nullable=False)
    person_notes = db.Column('person_notes', JSONB, nullable=True)
    ...
    def to_dict(self):
        return {
            ...
            'notes': self.notes,
            'person_is_favorite': self.person_is_favorite,
